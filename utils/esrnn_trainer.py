    ...
    def val(self):
        ...
        with torch.no_grad():
           ...
           # for batch_num, (train, val, test, info_cat, idx) in enumerate(self.dl):
            ...
            (hold_out_act, hold_out_act_deseas_norm), _ = self.model(train_t, val_t, test_t)
            ...
            results_path = 'model_checkpoints/esrnn/grouped_results_{}_epochs.csv'.format(self.epochs)
